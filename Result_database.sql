...
insert into Login values('fatema',101); 
insert into Login values('smith',102); 
...
insert into student(Student_id,Student_name,Address,Father_Name,Gender,Class,USER_AGE)
	values(101, 'Fatema','Rajshashi','Md Belal','Male','10','16');
insert into student(Student_id,Student_name,Address,Father_Name,Gender,Class,USER_AGE)
	values(102, 'smith','Chittagong','Md Selim','Female','10','16');
insert into student(Student_id,Student_name,Address,Father_Name,Gender,Class,USER_AGE)
	values(103, 'Raju Uddin','Dhaka','Md shahjahan','Male','10','17');
insert into student(Student_id,Student_name,Address,Father_Name,Gender,Class,USER_AGE)
	values(104, 'Nipu Jahan','Khulna','Md Manik','Female','10','15');
insert into student(Student_id,Student_name,Address,Father_Name,Gender,Class,USER_AGE)
	values(105, 'Tanjir Uddin','Chittagong','Md shahjahan','Male','10','16');	
/*-------------------------------------End --------------------------------------------------*/
